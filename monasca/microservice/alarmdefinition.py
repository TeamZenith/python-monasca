...
class AlarmDefinition(os_service.Service):

    def __init__(self, threads=1000):
        super(AlarmDefinition, self).__init__(threads)
            ...
            try:
                for msg in self._kafka_conn.get_messages():
                    if msg and msg.message:
                        LOG.debug(
                            "Message received for Alarm Definition methods: " + msg.message.value)
    ...
    def stop(self):
        ...
        super(AlarmDefinition, self).stop()
